...
p64 = Product.create([title:products[63][:title],description:products[63][:description],category:products[63][:category],quantity:rand(1..9) * 100 ,price:20.00,image:open(products[63][:image_path])])
p65 = Product.create([title:products[64][:title],description:products[64][:description],category:products[64][:category],quantity:rand(1..9) * 100 ,price:29.00,image:open(products[64][:image_path])])
...
p70 = Product.create([title:products[69][:title],description:products[69][:description],category:products[69][:category],quantity:rand(1..9) * 100 ,price:25.00,image:open(products[69][:image_path])])
...
p107 = Product.create([title:products[106][:title],description:products[106][:description],category:products[106][:category],quantity:rand(1..9) * 100 ,price:9.90,image:open(products[106][:image_path])])
...
p134 = Product.create([title:products[133][:title],description:products[133][:description],category:products[133][:category],quantity:rand(1..9) * 100 ,price:25.00,image:open(products[133][:image_path])])
...
p141 = Product.create([title:products[140][:title],description:products[140][:description],category:products[140][:category],quantity:rand(1..9) * 100 ,price:49.00,image:open(products[140][:image_path])])
...
p192 = Product.create([title:products[191][:title],description:products[191][:description],category:products[191][:category],quantity:rand(1..9) * 100 ,price:99.00,image:open(products[191][:image_path])])
