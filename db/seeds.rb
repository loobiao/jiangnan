...
p5 = Product.create([title:products[4][:title],description:products[4][:description],category:products[4][:category],quantity:rand(1..9) * 100 ,price:29.00,image:products[4][:image_path].map{|file|open(file)}])
