...
p2 = Product.create([title:products[1][:title],description:products[1][:description],category:products[1][:category],quantity:rand(1..9) * 100 ,price:29.00,image:products[1][:image_path].map{|file|open(file)}])
